...
_AGENT_ROSTER: list[dict[str, Any]] = [
    # ── Consultant side ──────────────────────────────────────────────────
    {"codename": "PM_ALEX",    "role": "Project Manager",          "side": "consultant",     "tier": "strategic",   "model": "MiniMax-M2.7",        "skills": ["project_management", "change_management"]},
    {"codename": "ARCH_SARA",  "role": "Solution Architect",       "side": "consultant",     "tier": "strategic",   "model": "MiniMax-M2.7",        "skills": ["sap_activate", "integration_pi", "abap_development"]},
    {"codename": "PMO_NIKO",   "role": "PMO Lead",                 "side": "consultant",     "tier": "strategic",   "model": "MiniMax-M2.7",        "skills": ["project_management", "testing_strategy"]},
    {"codename": "BASIS_KURT", "role": "Basis Administrator",      "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["basis_admin", "security_auth"]},
    {"codename": "FI_CHEN",    "role": "FI Lead",                  "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["fi_accounting", "co_controlling"]},
    {"codename": "CO_MARTA",   "role": "CO Lead",                  "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["co_controlling", "fi_accounting"]},
    {"codename": "MM_RAVI",    "role": "MM Lead",                  "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["mm_procurement", "wm_warehouse"]},
    {"codename": "SD_ISLA",    "role": "SD Lead",                  "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["sd_sales", "fi_accounting"]},
    {"codename": "PP_JONAS",   "role": "PP Lead",                  "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["pp_production", "mm_procurement"]},
    {"codename": "WM_FATIMA",  "role": "WM/EWM Lead",              "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["wm_warehouse", "mm_procurement"]},
    {"codename": "INT_MARCO",  "role": "Integration Lead",         "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["integration_pi", "abap_development"]},
    {"codename": "SEC_DIANA",  "role": "Security Lead",            "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["security_auth", "basis_admin"]},
    {"codename": "BI_SAM",     "role": "BI/Analytics Lead",        "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["bi_analytics", "fi_accounting"]},
    {"codename": "CHG_NADIA",  "role": "Change Management Lead",   "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["change_management", "testing_strategy"]},
    {"codename": "DM_FELIX",   "role": "Data Migration Lead",      "side": "consultant",     "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["data_migration", "abap_development"]},
    {"codename": "DEV_PRIYA",  "role": "Developer",                "side": "consultant",     "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["abap_development", "integration_pi"]},
    {"codename": "DEV_LEON",   "role": "Developer",                "side": "consultant",     "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["abap_development", "bi_analytics"]},
    # ── Customer side ────────────────────────────────────────────────────
    {"codename": "EXEC_VICTOR",   "role": "Executive Sponsor",         "side": "customer",   "tier": "strategic",   "model": "MiniMax-M2.7",        "skills": ["project_management"]},
    {"codename": "IT_MGR_HELEN",  "role": "IT Manager",                "side": "customer",   "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["basis_admin", "security_auth"]},
    {"codename": "CUST_PM_OMAR",  "role": "Customer Project Manager",   "side": "customer",   "tier": "senior",      "model": "MiniMax-M2.7",        "skills": ["project_management"]},
    {"codename": "QA_CLAIRE",     "role": "QA Lead",                   "side": "crossfunctional", "tier": "senior", "model": "MiniMax-M2.7",        "skills": ["testing_strategy"]},
    {"codename": "FI_KU_ROSE",    "role": "FI Key User",               "side": "customer",   "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["fi_accounting"]},
    {"codename": "CO_KU_BJORN",   "role": "CO Key User",               "side": "customer",   "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["co_controlling"]},
    {"codename": "MM_KU_GRACE",   "role": "MM Key User",               "side": "customer",   "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["mm_procurement"]},
    {"codename": "SD_KU_TONY",    "role": "SD Key User",               "side": "customer",   "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["sd_sales"]},
    {"codename": "BA_CUST_JAMES", "role": "Business Analyst",          "side": "customer",   "tier": "operational", "model": "MiniMax-M2.7",        "skills": ["sap_activate", "data_migration"]},
    {"codename": "WM_KU_ELENA",   "role": "WM Key User",               "side": "customer",   "tier": "basic",       "model": "MiniMax-M2.7",        "skills": ["wm_warehouse"]},
    {"codename": "PP_KU_IBRAHIM", "role": "PP Key User",               "side": "customer",   "tier": "basic",       "model": "MiniMax-M2.7",        "skills": ["pp_production"]},
    {"codename": "HR_KU_SOPHIE",  "role": "HR Key User",               "side": "customer",   "tier": "basic",       "model": "MiniMax-M2.7",        "skills": []},
    {"codename": "CHAMP_LEILA",   "role": "Change Champion",           "side": "customer",   "tier": "basic",       "model": "MiniMax-M2.7",        "skills": ["change_management"]},
]
